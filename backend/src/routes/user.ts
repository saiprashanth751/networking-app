...
app.post("/profile", authMiddleware, upload.single('profilePic'), uploadToCloudinary('profilePic'), createProfile);
app.put("/profile", authMiddleware, upload.single('profilePic'), uploadToCloudinary('profilePic'), updateProfile);
